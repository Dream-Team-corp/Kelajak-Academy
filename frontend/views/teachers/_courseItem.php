...
<div class="project-wrap">
    <a href="<?= Url::to(['course/view', 'id' => $model->id]) ?>" class="img"
       style="background-image: url(<?= Yii::getAlias('@defaultImage') . '/' . $model->image ?>)">
    ...
    <div class="text p-4">
        ...
        <p class="advisor">O'qituvchi: <span><a
                        href="<?= Url::to(['teachers/view', 'id' => $model->user->id]) ?>"><?= $model->user->first_name ?></a></span>
        </p>
