...
use yii\helpers\Url;
$image = (empty(Yii::$app->user->identity->teacherInfo->image)) ? Yii::$app->user->identity->photo : Yii::$app->user->identity->teacherInfo->image;
?>
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?= Yii::getAlias('@defaultImage') .'/'. $image  ?>" class="img-circle elevation-2" width="250" height="250">
            </div>
            <div class="info">
        ...
        <nav class="mt-2">
            ...
            echo \hail812\adminlte\widgets\Menu::widget([
                'items' => [
                    ...
                    ['label' => 'Topshiriqlar', 'icon' => '', 'iconClassAdded' => 'text-info', 'url' => ['/teacher/task/index']],
